...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("devdaljeet.scavenge.scavenge.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Scavenge(request) {
        const data = QueryGetScavengeRequest.encode(request).finish();
        const promise = this.rpc.request("devdaljeet.scavenge.scavenge.Query", "Scavenge", data);
    ...
    ScavengeAll(request) {
        ...
        const promise = this.rpc.request("devdaljeet.scavenge.scavenge.Query", "ScavengeAll", data);
    ...
    Commit(request) {
        ...
        const promise = this.rpc.request("devdaljeet.scavenge.scavenge.Query", "Commit", data);
    ...
    CommitAll(request) {
        ...
        const promise = this.rpc.request("devdaljeet.scavenge.scavenge.Query", "CommitAll", data);
