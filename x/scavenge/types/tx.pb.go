...
func init() {
	...
	proto.RegisterType((*MsgRevealSolution)(nil), "devdaljeet.scavenge.scavenge.MsgRevealSolution")
	proto.RegisterType((*MsgRevealSolutionResponse)(nil), "devdaljeet.scavenge.scavenge.MsgRevealSolutionResponse")
}
...
var fileDescriptor_62ec6f1544538068 = []byte{
	...
	,
}
...
func (c *msgClient) RevealSolution(ctx context.Context, in *MsgRevealSolution, opts ...grpc.CallOption) (*MsgRevealSolutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/devdaljeet.scavenge.scavenge.Msg/RevealSolution", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RevealSolution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/devdaljeet.scavenge.scavenge.Msg/RevealSolution",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
